...
const Register = () => {
  ...
  const submitHandler = e => {
    e.preventDefault();
    axios
      .post('https://stormy-basin-77789.herokuapp.com/api/auth/register', user)
      .then(res => {
  ...
  return (
    <React.Fragment>
      <form onSubmit={submitHandler}>
        ...
        <input type='text' name='email' value={user.email} placeholder='email' onChange={changeHandler} required />
